...
*/
  ...
  d3.rebind(chart, lines, 'points', 'series', 'seriesKey', 'defined', 'isArea', 'x', 'y', 'size', 'xDomain', 'yDomain', 'forceX', 'forceY', 'interactive', 'clipEdge', 'clipVoronoi', 'id');
...
nv.models.lineChart = function() {
  ...
  var showTooltip = function(e, offsetElement) {
    ...
    var left = e.pos[0] + ( offsetElement.offsetLeft || 0 ),
        ...
        x = xAxis.tickFormat()(lines.x()(e.point, e.pointIndex)),
        y = yAxis.tickFormat()(lines.y()(e.point, e.pointIndex)),
        content = tooltip(lines.seriesKey()(e.series, e.seriesIndex), x, y, e, chart);
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      legend.dispatch.on('legendClick', function(d,i) { 
        ...
        if (!lines.series()(data).filter(function(d) { return !d.disabled }).length) {
          lines.series()(data).map(function(d) {
            d.disabled = false;
            wrap.selectAll('.nv-series').classed('disabled', false);
            return d;
          });
...
*/
  ...
  d3.rebind(chart, lines, 'points', 'series', 'seriesKey', 'defined', 'isArea', 'x', 'y', 'size', 'xScale', 'yScale', 'xDomain', 'yDomain', 'forceX', 'forceY', 'interactive', 'clipEdge', 'clipVoronoi', 'id', 'interpolate');
...
nv.models.linePlusBarChart = function() {
  ...
  var lines = nv.models.line().removeBars(true),
      bars = nv.models.historicalBar(),
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var linesWrap = g.select('.nv-linesWrap')
          .datum(dataLines.length ? data : [{values:[]}])
  ...
  d3.rebind(chart, lines, 'points', 'series', 'seriesKey', 'defined', 'size', 'clipVoronoi', 'interpolate');
  //TODO: consider rebinding x, y and some other stuff, and simply do soemthign lile bars.x(lines.x()), etc.
  //d3.rebind(chart, lines, 'x', 'y', 'size', 'xDomain', 'yDomain', 'forceX', 'forceY', 'interactive', 'clipEdge', 'clipVoronoi', 'id');
...
nv.models.scatterChart = function() {
  ...
  var showTooltip = function(e, offsetElement) {
    ...
    var left = e.pos[0] + ( offsetElement.offsetLeft || 0 ),
      ...
      if( tooltipX != null )
          nv.tooltip.show([leftX, topX], tooltipX(scatter.seriesKey()(e.series, e.seriesIndex), xVal, yVal, e, chart), 'n', 1, null, 'x-nvtooltip');
      if( tooltipY != null )
          nv.tooltip.show([leftY, topY], tooltipY(scatter.seriesKey()(e.series, e.seriesIndex), xVal, yVal, e, chart), 'e', 1, null, 'y-nvtooltip');
      if( tooltip != null )
          nv.tooltip.show([left, top], tooltip(scatter.seriesKey()(e.series, e.seriesIndex), xVal, yVal, e, chart), e.value < 0 ? 'n' : 's');
  };
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      legend.dispatch.on('legendClick', function(d,i, that) {
        ...
        if (!scatter.series()(data).filter(function(d) { return !d.disabled }).length) {
          scatter.series()(data).map(function(d) {
            d.disabled = false;
            wrap.selectAll('.nv-series').classed('disabled', false);
            return d;
          });
  ...
  d3.rebind(chart, scatter, 'id', 'interactive', 'pointActive', 'points', 'series', 'seriesKey', 'x', 'y', 'shape', 'size', 'xScale', 'yScale', 'zScale', 'xDomain', 'yDomain', 'sizeDomain', 'forceX', 'forceY', 'forceSize', 'clipVoronoi', 'clipRadius');
